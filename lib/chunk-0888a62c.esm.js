...
import { EditorState, Modifier, genKey, SelectionState } from 'draft-js';
...
var defaultEmojiGroups = [{
  title: 'People',
  icon: /*#__PURE__*/React.createElement(FaSmileO, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Food & Drink',
  icon: /*#__PURE__*/React.createElement(FaCutlery, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Activity',
  icon: /*#__PURE__*/React.createElement(FaFutbolO, {
    style: {
      verticalAlign: ''
    }
  }),
...
var Popover = loadable(function () {
  return import('./chunk-09b9fc8c.esm.js');
}, {
  ...
  _createClass(EmojiSelect, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        type: "button"
      }, selectButtonContent), this.state.isOpen && /*#__PURE__*/React.createElement(Popover, {
        cacheBustParam: cacheBustParam,
        imagePath: imagePath,
        imageType: imageType,
        theme: theme,
...
export { _defineProperty as _, _inherits as a, _createSuper as b, _classCallCheck as c, defaultTheme as d, _assertThisInitialized as e, _createClass as f, emojiList as g, convertShortNameToUnicode as h, index as i, _extends as j, addEmoji as k };
